...
const HeroSection = () => {
  return (
    <div className="flex flex-col justify-center items-center h-full text-center text-white">
        ...
        <button className="mt-8 px-8 py-3 bg-gray-500 bg-opacity-50 rounded-lg text-white hover:bg-pink-700 transition duration-300" onClick={() => window.location.href = 'https://forms.gle/hQoFjzQsJ46hzERdA'}>
              Register for upcoming MLOps Speaker Session on 5 Aug 2024!
        </button>
    </div>
  )
}
